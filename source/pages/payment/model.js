...
export const getTotalPayment = count => data.reduce((sum, num) => parseFloat(sum.toFixed(2)) + num[count], 0);

export const getAvgPayment = (obj) => {
	const data = {};
	for (let key in obj) {
			data[key] = obj[key].getAvgPayment().toFixed(2);
	}
	return data;
};